...
namespace BlackCore
{
    namespace Afv
    {
        namespace Audio
        {
            ...
            void CSoundcardSampleProvider::setGainRatioForTranseiver(quint16 transceiverID, double gainRatio)
            {
                ...
                if (receiverInput == m_receiverInputs.end()) { return; }
                (*receiverInput)->setGainRatio(gainRatio);
            }
