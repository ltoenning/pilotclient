        ...
        namespace Clients
        {
            ...
            void CAfvClient::startAudio(const CAudioDeviceInfo &inputDevice, const CAudioDeviceInfo &outputDevice)
            {
                ...
                // threadsafe block
                {
                    // lock block 1
                    {
                        ...
                        //m_outputSampleProvider->setGainRatio(outputVolume); // FIXME: Should we even set overall volume?
                    }
            ...
            */
            ...
            bool CAfvClient::setOutputVolumeDb(CComSystem::ComUnit comUnit, double valueDb)
            {
                ...
                {
                    m_soundcardSampleProvider->setGainRatioForTranseiver(comUnit, gainRatio);
                }
